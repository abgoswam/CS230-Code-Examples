...
def load_dataset(path_csv):
    ...
    with (open(path_csv, encoding="utf8") if use_python3 else open(path_csv)) as f:
        ...
        # do not forget to write the last sentence.
        dataset.append((words, tags))
...
if __name__ == "__main__":
    ...
    path_dataset = 'data/skylight/skylight_ner_test.csv'
    ...
    print("Loading Skylight dataset into memory...")
    ...
    # save_dataset(train_dataset, 'data/skylight/train')
    # save_dataset(val_dataset, 'data/kaggle/val')
    save_dataset(test_dataset, 'data/skylight/test')